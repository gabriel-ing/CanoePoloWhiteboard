#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/gabriel/.vscode/extensions/wallabyjs.console-ninja-1.0.409/out/buildHook/index.js').default({tool: 'serve', checkSum: '20af1e3b6e4ff209e0274dUFIfVx1WDAMBUFQCVgFUUwtRDF1T', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/gabriel/.vscode/extensions/wallabyjs.console-ninja-1.0.409/out/buildHook/index.js').then(m => m.default.default({tool: 'serve', checkSum: '20af1e3b6e4ff209e0274dUFIfVx1WDAMBUFQCVgFUUwtRDF1T', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
